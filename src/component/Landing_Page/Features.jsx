...
export function Features() {
  ...
  return (
    <div className="p-5 border-b-2 mt-10 mb-20" id="feature">
      <h4 className="d-flex justify-content-center text-center font-bold  mb-36 mt-10 text-6xl feature_heading relative">
        Features
      ...
      <div className="grid lg:grid-cols-3 grid-flow-row gap-10 md:grid-cols-2 grid-cols-1 sm:grid-cols-1">
        {features.map((item) => (
          <div
            key={item.key} // Ensure each card has a unique key prop
          ...
          >
            <img height={200} width={200} src={item.tagName} alt={item.title} />
            <h3
