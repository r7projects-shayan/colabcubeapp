...
export function Near() {
  return (
    <div className="p-5 mt-36" id="demo">
      <h4 className="d-flex justify-content-center text-center mb-46 text-6xl feature_heading relative">
        <span className="z-10 text-center font-bold mb-36">
          NEAR X COLABCUBE
        </span>
        <span className="w-25 mb-36 z-4 bg-orange-400 absolute bottom-0 h-50"></span>
      </h4>

      {demo.map((item, index) => (
        <div
          key={index}
          className="grid mt-36 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 sm:grid-cols-1 grid-flow-row p-3 justify-items-center align-items-center"
        >
          {index % 2 === 0 ? (
            <>
